...
namespace pbwrap
{
    ...
    namespace utils
    {
            ...
            -> std::tuple<uint32_t, uint32_t, std::string, std::string>
        {
            ...
            case WIRETYPE_START_GROUP:
                throw std::runtime_error(_S("WIRETYPE_START_GROUP not implemented"));
                break;
            case WIRETYPE_END_GROUP:
                throw std::runtime_error(_S("WIRETYPE_END_GROUP not implemented"));
                break;
            case WIRETYPE_FIXED32:
                ...
                break;
            default:
                throw std::runtime_error(_S("Unknown wire type"));
                break;
            }
    ...
    namespace base
    {
        struct field_vector
        {
            ...
            {
                if (field >= max_size)
                    throw std::runtime_error(_S("field range error"));
