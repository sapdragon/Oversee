...
public:
    ...
    bool ShouldHitEntity( IHandleEntity* pEntityHandle, int /*contentsMask*/ )
    {
        return ( void* ) ( pEntityHandle ) != ( void* ) ( pEnt ) && ( ( IClientEntity* ) pEntityHandle )->GetClientClass( )->m_ClassID == 40;
    }
    virtual TraceType GetTraceType( ) const
    {
        return TraceType::TRACE_ENTITIES_ONLY;
...
{
public:
    inline VectorAligned( void ) {}; //-V730
    inline VectorAligned( float X, float Y, float Z ) //-V730
    {
        Init( X, Y, Z );
    }
...
struct Ray_t
{
    ...
    void Init( Vector const& start, Vector const& end )
    {
        ...
        m_IsSwept = m_Delta.LengthSqr( ) > FLT_EPSILON;
