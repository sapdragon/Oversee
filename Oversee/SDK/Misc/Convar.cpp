...
void ConVar::SetFloat( float flValue )
{
    ConVar* var = (ConVar*)m_pParent;
    var->InternalSetFloatValue( flValue );
}

void ConVar::SetString(const char* szValue)
{
    ConVar* var = (ConVar*)m_pParent;
    var->InternalSetValue(szValue);
}

void ConVar::SetInt( int iValue )
{
    ConVar* var = (ConVar*)m_pParent;
    var->InternalSetIntValue(iValue);
}
